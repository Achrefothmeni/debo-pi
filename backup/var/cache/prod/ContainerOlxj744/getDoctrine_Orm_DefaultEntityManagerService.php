...
$c = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver(${($_ = isset($this->services['annotation_reader']) ? $this->services['annotation_reader'] : $this->getAnnotationReaderService()) && false ?: '_'}, [0 => ($this->targetDirs[3].'\\src\\ArticleBundle\\Entity'), 1 => ($this->targetDirs[3].'\\src\\AuthBundle\\Entity'), 2 => ($this->targetDirs[3].'\\src\\ResourcesBundle\\Entity'), 3 => ($this->targetDirs[3].'\\src\\LivraisonBundle\\Entity'), 4 => ($this->targetDirs[3].'\\src\\FluxBundle\\Entity'), 5 => ($this->targetDirs[3].'\\src\\ReclamationBundle\\Entity'), 6 => ($this->targetDirs[3].'\\src\\CommandeBundle\\Entity')]);

$b->addDriver($c, 'ArticleBundle\\Entity');
$b->addDriver($c, 'AuthBundle\\Entity');
$b->addDriver($c, 'ResourcesBundle\\Entity');
$b->addDriver($c, 'LivraisonBundle\\Entity');
$b->addDriver($c, 'FluxBundle\\Entity');
...
$a->setEntityNamespaces(['ArticleBundle' => 'ArticleBundle\\Entity', 'AuthBundle' => 'AuthBundle\\Entity', 'ResourcesBundle' => 'ResourcesBundle\\Entity', 'LivraisonBundle' => 'LivraisonBundle\\Entity', 'FluxBundle' => 'FluxBundle\\Entity', 'ReclamationBundle' => 'ReclamationBundle\\Entity', 'CommandeBundle' => 'CommandeBundle\\Entity']);
