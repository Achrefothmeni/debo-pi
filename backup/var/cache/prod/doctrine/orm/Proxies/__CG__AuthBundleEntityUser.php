 ...
 */
class User extends \AuthBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'matFiscal', 'nom', 'prenom', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'plainPassword', 'lastLogin', 'confirmationToken', 'passwordRequestedAt', 'groups', 'roles'];
        }
    ...
    public function getMatFiscal()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getMatFiscal', []);

        return parent::getMatFiscal();
    }
    ...
    public function setMatFiscal($matFiscal)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setMatFiscal', [$matFiscal]);

        return parent::setMatFiscal($matFiscal);
    }
