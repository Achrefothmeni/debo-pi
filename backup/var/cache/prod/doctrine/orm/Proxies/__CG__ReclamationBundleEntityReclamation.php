...
class Reclamation extends \ReclamationBundle\Entity\Reclamation implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'ReclamationBundle\\Entity\\Reclamation' . "\0" . 'id', '' . "\0" . 'ReclamationBundle\\Entity\\Reclamation' . "\0" . 'message', '' . "\0" . 'ReclamationBundle\\Entity\\Reclamation' . "\0" . 'type', '' . "\0" . 'ReclamationBundle\\Entity\\Reclamation' . "\0" . 'status'];
        }
