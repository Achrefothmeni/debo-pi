 ...
 */
class Facture extends \FluxBundle\Entity\Facture implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'FluxBundle\\Entity\\Facture' . "\0" . 'id', '' . "\0" . 'FluxBundle\\Entity\\Facture' . "\0" . 'prixtotal'];
        }
