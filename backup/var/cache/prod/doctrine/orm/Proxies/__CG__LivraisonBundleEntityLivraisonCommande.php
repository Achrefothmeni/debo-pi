 ...
 */
class LivraisonCommande extends \LivraisonBundle\Entity\LivraisonCommande implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'LivraisonBundle\\Entity\\LivraisonCommande' . "\0" . 'id', '' . "\0" . 'LivraisonBundle\\Entity\\LivraisonCommande' . "\0" . 'livraison', '' . "\0" . 'LivraisonBundle\\Entity\\LivraisonCommande' . "\0" . 'commande'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (LivraisonCommande $proxy) {
