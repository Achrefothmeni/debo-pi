 ...
 */
class lignecommande extends \CommandeBundle\Entity\lignecommande implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'CommandeBundle\\Entity\\lignecommande' . "\0" . 'id', '' . "\0" . 'CommandeBundle\\Entity\\lignecommande' . "\0" . 'qte', '' . "\0" . 'CommandeBundle\\Entity\\lignecommande' . "\0" . 'commande'];
        }
