...
class __TwigTemplate_4b4aa7e232f97d3c1d19c387beed1a2218dc8e8634aa115ea872f45c1a8f5c06 extends \Twig\Template
{
    ...
    <table>
        <tbody>
            <tr>
                ...
                <td>";
        // line 10
        echo twig_escape_filter($this->env, $this->getAttribute(($context["reclamation"] ?? $this->getContext($context, "reclamation")), "id", []), "html", null, true);
        echo "</td>
            </tr>
            <tr>
                <th>Message</th>
                <td>";
        // line 14
        echo twig_escape_filter($this->env, $this->getAttribute(($context["reclamation"] ?? $this->getContext($context, "reclamation")), "message", []), "html", null, true);
        echo "</td>
            </tr>
            <tr>
                <th>Type</th>
                <td>";
        // line 18
        echo twig_escape_filter($this->env, $this->getAttribute(($context["reclamation"] ?? $this->getContext($context, "reclamation")), "type", []), "html", null, true);
        echo "</td>
            </tr>
        </tbody>
    </table>
    ...
    <ul>
        ...
        <li>
            <a href=\"";
        // line 28
        echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getPath("reclamation_edit", ["id" => $this->getAttribute(($context["reclamation"] ?? $this->getContext($context, "reclamation")), "id", [])]), "html", null, true);
        echo "\">Edit</a>
        </li>
        <li>
            ";
...
{% endblock %}
", "reclamation/show.html.twig", "C:\\xampp\\htdocs\\debo-pi\\app\\Resources\\views\\reclamation\\show.html.twig");
    }
}
